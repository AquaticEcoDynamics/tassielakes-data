...
% Models
master.ncfile(1).name = '/Projects2/csiem/Model/TFV/csiem_model_tfvaed_1.1/outputs/results/csiem_v1_A001_20220101_20221231_WQ_lowRes_WQ.nc';
...
timeseries.outputdirectory = '../outputs/MARVL_TEST/RAW/';
timeseries.htmloutput = '../outputs/MARVL_TEST/HTML/';
timeseries.ErrFilename = '../outputs/MARVL_TEST/errormatrix.mat';
...
timeseries.datearray = datenum(2015:01:2024,01,1);
